...
namespace Device.device.spectrometer
{
    public class BanSpectrometer : ISpectrometer
    {
        ...
        public int CheckIndex(string spectrometerSerial)
        {
            ...
            {
                COMMON.Log.Error("Spectrometer :: CheckIndex " + except.ToString());
        ...
        public bool SetIntegrationTime(int integrationTime)
        {
            ...
            {
                COMMON.Log.Error("Spectrometer :: SetIntegrationTime " + except.ToString());
        ...
        public bool SetRemoveDark()
        {
            ...
            {
                COMMON.Log.Error("Spectrometer :: SetRemoveDark " + except.ToString());
                return false;
            }
        }
        ...
        public bool SetSamplingCount(int samplingCount)
        {
            ...
            {
                COMMON.Log.Error("Spectrometer :: SetSamplingCount " + except.ToString());
                LastErrorMsg = except.ToString();
                return false;
            }
        }
